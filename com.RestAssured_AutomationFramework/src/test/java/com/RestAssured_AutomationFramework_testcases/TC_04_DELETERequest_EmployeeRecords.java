...
public class TC_04_DELETERequest_EmployeeRecords extends Testbase {
	...
	void create_Employee() throws InterruptedException {
		...
		// Get the Jsonpath object from json response
	...
	void checkResponseBody() {
		...
		Assert.assertEquals(response_body.contains("Successfully! Record has been deleted"),true);
	...
	void checkContentLength() {
		...
		Assert.assertEquals(content_length, "84");
