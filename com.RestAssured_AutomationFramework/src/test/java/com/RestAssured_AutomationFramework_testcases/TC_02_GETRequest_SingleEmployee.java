...
public class TC_02_GETRequest_SingleEmployee extends Testbase {
	
	@BeforeClass
	public void getAllEmp() throws InterruptedException {

		logger.info("*** TC_02_GETRequest_SingleEmployee ***");
	...
	public void tearDown() {
		...
		logger.info("*** TC_02_GETRequest_SingleEmployee finish ***");
	}
